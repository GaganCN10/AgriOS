...
HAZARDOUS_PATTERNS = [
    (r"paraquat(?:\s*(?:\+|and|with|,|/|&|plus)\s*)glyphosate", "Combining Paraquat and Glyphosate is highly hazardous and can cause toxic soil locking and severe human respiratory risk. Do not mix these herbicides."),
    (r"monocrotophos(?:\s*(?:\+|and|with|,|/|&|plus)\s*)pesticide", "Monocrotophos is extremely toxic and banned on many food crops. Mixing it with other pesticides is highly dangerous for farm workers."),
